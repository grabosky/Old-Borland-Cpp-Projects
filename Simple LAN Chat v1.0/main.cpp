...
void __fastcall TChatForm::FileListenItemClick(TObject *Sender)
{
  ...
  if (FileListenItem->Checked)
  {
     ...
     StatusBar1->Panels->Items[0]->Text = "Czekam na po³¹czenie...";
  }else
  {
...
void __fastcall TChatForm::FileConnectItemClick(TObject *Sender)
{
  ...
  if (InputQuery("Wpisz nr IP drugiego czatowicza", "Numer IP:", Server))
  {
     if (Server.Length() > 0)
     {
...
{
  StatusBar1->Panels->Items[0]->Text = "Po³¹czony z: " + Socket->RemoteHost;   
}
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
...
{
  IsServer = true;
  StatusBar1->Panels->Items[0]->Text = "Po³¹czony z: " + Socket->RemoteAddress;   
}
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
